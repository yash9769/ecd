    ...
    <>
      ...
      <section className="paper relative">
        <div className={`${WRAP} pt-36 pb-24 lg:pt-44`}>
          ...
          <h1 className="mt-6 max-w-4xl font-display text-5xl font-extrabold leading-[1.0] tracking-[-0.03em] text-[#14121a] lg:text-7xl">
          ...
          <div className="mt-16 grid gap-px" style={{ background: "rgba(20,18,26,0.12)" }}>
            {METHOD.map((m, i) => (
              <Reveal key={m.n} delay={i * 90}>
                <div className="grid grid-cols-1 items-start gap-6 bg-[#f2f0ea] px-2 py-9 sm:grid-cols-[120px_1fr_1fr]">
                  <span className="font-display text-6xl font-extrabold leading-none text-[#8b5cf6]">{m.n}</span>
                  <h3 className="font-display text-2xl font-bold text-[#14121a]">{m.t}</h3>
          ...
          <Reveal delay={120}>
            <div className="mt-16 grid gap-px sm:grid-cols-3" style={{ background: "rgba(20,18,26,0.12)" }}>
              {[
                ...
                <div key={t} className="bg-[#f2f0ea] p-7">
